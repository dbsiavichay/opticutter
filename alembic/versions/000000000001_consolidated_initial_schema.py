...
def upgrade() -> None:
    ...
    # users <-> branches has a circular FK (users.branch_id -> branches.id,
    # branches.created_by/updated_by -> users.id): create users first without
    # the branch_id FK, then branches, then add the FK back.
    op.create_table(
        "users",
