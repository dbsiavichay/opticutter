...
Revises:
Create Date: 2026-07-07 17:19:10.878265

Single consolidated schema (the project keeps one squashed initial migration).
Regenerated to add: a metadata naming convention, composite/hot-path indexes,
CHECK constraints, explicit ON DELETE rules (SET NULL for audit/actor FKs,
CASCADE for order/preorder children) and DB-level server defaults on the
timestamp columns. A database already on the previous consolidated schema is
recreated or ``alembic stamp head``-ed (it does not receive the new
indexes/constraints automatically).
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_branches_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_branches_updated_by_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_foreign_key(
        op.f("fk_users_branch_id_branches"), "users", "branches", ["branch_id"], ["id"]
    )
    op.create_table(
        "clients",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_clients_updated_by_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_settings_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_user_login_events_user_id_users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["branch_id"],
            ["branches.id"],
            name=op.f("fk_optimization_drafts_branch_id_branches"),
        ),
        sa.ForeignKeyConstraint(
            ["client_id"],
            ["clients.id"],
            name=op.f("fk_optimization_drafts_client_id_clients"),
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_optimization_drafts_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_optimization_drafts_updated_by_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_orders_discount_rate_ratio"),
        ),
        sa.CheckConstraint(
            "payment_cash_amount >= 0", name=op.f("ck_orders_payment_cash_non_negative")
        ),
        sa.CheckConstraint(
            "payment_credit_amount >= 0",
            name=op.f("ck_orders_payment_credit_non_negative"),
        ),
        sa.CheckConstraint(
            "subtotal >= 0", name=op.f("ck_orders_subtotal_non_negative")
        ),
        sa.CheckConstraint("total >= 0", name=op.f("ck_orders_total_non_negative")),
        sa.ForeignKeyConstraint(
            ["assigned_to_id"],
            ["users.id"],
            name=op.f("fk_orders_assigned_to_id_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["banding_finished_by"],
            ["users.id"],
            name=op.f("fk_orders_banding_finished_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["banding_started_by"],
            ["users.id"],
            name=op.f("fk_orders_banding_started_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["branch_id"], ["branches.id"], name=op.f("fk_orders_branch_id_branches")
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["dispatched_by"],
            ["users.id"],
            name=op.f("fk_orders_dispatched_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
    ...
    op.create_index(
        "ix_orders_branch_status", "orders", ["branch_id", "status"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_order_attachments_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
            ["orders.id"],
            name=op.f("fk_order_attachments_order_id_orders"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_order_attachments_updated_by_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "half_board", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_order_boards_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
            ["orders.id"],
            name=op.f("fk_order_boards_order_id_orders"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["product_id"],
            ["products.id"],
            name=op.f("fk_order_boards_product_id_products"),
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_order_boards_updated_by_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_by", sa.Integer(), nullable=True),
        sa.CheckConstraint(
            "line_total >= 0", name=op.f("ck_order_lines_line_total_non_negative")
        ),
        sa.CheckConstraint(
            "quantity > 0", name=op.f("ck_order_lines_quantity_positive")
        ),
        sa.CheckConstraint(
            "unit_price_snapshot >= 0",
            name=op.f("ck_order_lines_unit_price_non_negative"),
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_order_lines_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
        ...
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_order_lines_updated_by_users"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_order_lines")),
    )
    op.create_index(
        "ix_order_lines_order_id", "order_lines", ["order_id"], unique=False
    )
    op.create_table(
        "order_pieces",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column("updated_by", sa.Integer(), nullable=True),
        sa.CheckConstraint(
            "quantity > 0", name=op.f("ck_order_pieces_quantity_positive")
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_order_pieces_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
            ["orders.id"],
            name=op.f("fk_order_pieces_order_id_orders"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["product_id"],
            ["products.id"],
            name=op.f("fk_order_pieces_product_id_products"),
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_order_pieces_updated_by_users"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_order_pieces")),
    )
    op.create_index(
        "ix_order_pieces_order_id", "order_pieces", ["order_id"], unique=False
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_order_status_history_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
        ...
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_order_status_history_updated_by_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "strategy", sa.String(length=32), server_default="default", nullable=False
        ),
        sa.Column("source", sa.String(length=32), nullable=True),
        sa.Column("notes", sa.String(length=512), nullable=True),
        ...
        sa.Column("updated_by", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ["branch_id"], ["branches.id"], name=op.f("fk_preorders_branch_id_branches")
        ),
        sa.ForeignKeyConstraint(
            ["client_id"], ["clients.id"], name=op.f("fk_preorders_client_id_clients")
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_preorders_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
            ["orders.id"],
            name=op.f("fk_preorders_order_id_orders"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_preorders_updated_by_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        "ix_preorders_branch_status", "preorders", ["branch_id", "status"], unique=False
    )
    op.create_index(
        "ix_preorders_client_status", "preorders", ["client_id", "status"], unique=False
    )
    op.create_table(
        "order_placed_pieces",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["board_id"],
            ["order_boards.id"],
            name=op.f("fk_order_placed_pieces_board_id_order_boards"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_order_placed_pieces_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["cut_by"],
            ["users.id"],
            name=op.f("fk_order_placed_pieces_cut_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
            ["orders.id"],
            name=op.f("fk_order_placed_pieces_order_id_orders"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_order_placed_pieces_updated_by_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_preorder_review_links_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["preorder_id"],
            ["preorders.id"],
            name=op.f("fk_preorder_review_links_preorder_id_preorders"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_preorder_review_links_updated_by_users"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_preorder_review_links")),
        sa.UniqueConstraint(
            "token_hash", name=op.f("uq_preorder_review_links_token_hash")
        ),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["actor_user_id"],
            ["users.id"],
            name=op.f("fk_preorder_status_history_actor_user_id_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("fk_preorder_status_history_created_by_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["preorder_id"],
            ["preorders.id"],
            name=op.f("fk_preorder_status_history_preorder_id_preorders"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
            name=op.f("fk_preorder_status_history_updated_by_users"),
            ondelete="SET NULL",
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_preorder_review_links_preorder_id"), table_name="preorder_review_links"
    )
