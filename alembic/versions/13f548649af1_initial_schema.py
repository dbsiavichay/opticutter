...
Revision ID: 13f548649af1
Revises: 
Create Date: 2026-06-18 13:51:35.522177
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_preorders_branch_id'), 'preorders', ['branch_id'], unique=False)
